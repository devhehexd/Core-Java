...
public class StreamDemo {
    public static void main(String[] args) {
        ...
        String[] strArray = {"사과", " 배", "딸기", "복숭아", "레본", "망고", "수박"};
        ...
        List<String> list = Arrays.asList("사과", " 배", "딸기", "복숭아", "레본", "망고", "수박");
        Stream<String> s5 = list.stream();

        List<Integer> list1 = Arrays.asList(3, 4, 5, 1, 2, 3);
        Stream<Integer> s6 = list1.stream();

        Set<String> set = new HashSet<>(Arrays.asList("사과", " 배", "딸기", "복숭아", "레본", "망고", "수박"));
        ...
        DoubleStream ds1 = new Random().doubles(15L, 1.0, 10.0); //1.0~10.0 사이 난수 15개
        IntStream is1 = new Random().ints(5, 1, 10); //1~10사이 난수 5개
